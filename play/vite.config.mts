...
// Load svelte-preprocess via dynamic import so Vite's bundled config does not inline it; inlining breaks
// its dynamic require("./transformers/...") paths (500 on .svelte requests in dev).
